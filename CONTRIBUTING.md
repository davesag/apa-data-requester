# How to contribute to the APA Data Requester project
...
3. Set this repo as the `upstream` repo `git remote add upstream git@github.com:davesag/apa-data-requester.git`
...
5. Use GitHub to raise a Pull Request. Add labels as appropriate. Then paste the url of the PR into the `#development` Slack channel with a request for someone to please review the changes. See below for how to name pull requests.
